            ...
            <div class="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-md">
                <div v-if="!file" class="space-y-1 text-center">
                    ...
                    <div class="flex text-sm text-gray-600 dark:text-gray-200">
                        <label class="relative cursor-pointer bg-white dark:bg-gray-600 dark:text-blue-300 rounded-md  font-medium text-blue-600 hover:text-blue-500 dark:hover:text-blue-200 focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-blue-500">
                ...
                <div v-for="(value, index) in localMapping" :key="value.key">
                    <div class="flex justify-between">
                        ...
                        <div class="flex w-1/2">
                            <select :value="localMapping[index].value" @change="(event) => changeHeader(event.target.value, index)" class="mt-1 block w-full py-2 px-3 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
