                ...
                <div class="inline-block align-bottom bg-white dark:bg-gray-600 rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full sm:p-6">
                    ...
                    <div class="my-4">
                        <div class="text-left">
                            ...
                            <div class="mt-2">
                                <select v-model="form.type" class="block max-w-lg w-full dark:bg-gray-500 shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm border-gray-300 dark:border-gray-600 rounded-md">
