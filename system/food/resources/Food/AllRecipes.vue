    ...
    <div>
        <div class="container mx-auto row justify-content-center">
            <div class="flex flex-wrap w-full">
                <div class="bg-white w-full mx-2 overflow-hidden shadow rounded">
                    <input v-model="search.query" type="text" @keyup.enter="searchQuery" class="w-full p-3 border-b border-grey-lighter text-grey-darker focus:outline-none" placeholder="Search for things...">
        ...
        <div class="flex flex-wrap container" v-if="!search.loading">
            ...
            <pagination class="mx-auto" :limit="10" :data="recipes" @pagination-change-page="getNewRecipes"></pagination>
        </div>
    ...
    export default {
        ...
        methods: {
            searchQuery() {
                ...
                axios.post('/api/search', searchingFor)
                    .then(res => {
